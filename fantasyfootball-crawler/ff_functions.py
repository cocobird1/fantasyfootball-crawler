...
def weightedRankings(df, weights):
    ...
    ----------
    String
        df, a DataFrame that is generated by some of the other functons, or user input
        weights, an array of floats, adding up to 1, that define the weight of each column in the df
